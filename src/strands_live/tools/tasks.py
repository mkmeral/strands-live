...
TOOL_SPEC = {
    "name": "tasks",
    "description": "Create and manage background tasks with powerful specialized AI agents that have "
    "access to comprehensive toolkits. If you don't know how to answer a user's request or need expert "
    "assistance, ALWAYS use this tool to delegate to specialized agents with different expertise areas. "
    "These agents can access internet, user's files and user's AWS account. Use these agents to access "
    "this information.",
    "inputSchema": {
        "json": {
            "type": "object",
