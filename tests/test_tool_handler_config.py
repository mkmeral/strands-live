...
class TestToolHandlerConfiguration:
    ...
    def test_custom_configuration_override(self):
        ...
        assert handler.get_config('order_statuses') == ['Processing', 'Shipped', 'Delivered']
    ...
    async def test_order_status_configuration_impact(self):
        ...
        handler = ToolHandler({
            'order_statuses': custom_statuses,
    ...
    def test_handler_info_includes_config(self):
        ...
        expected_keys = {'timezone', 'order_statuses', 'status_weights', 'custom_key1', 'custom_key2'}
