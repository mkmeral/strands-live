...
from src.bedrock_streamer import BedrockStreamManager
...
class TestBedrockStreamManager:
    ...
    def test_start_prompt_event_structure(self):
        ...
        assert data["event"]["promptStart"]["promptName"] == self.stream_manager.prompt_name
    ...
    def test_tool_result_event_with_dict(self):
        ...
        assert data["event"]["toolResult"]["promptName"] == self.stream_manager.prompt_name
    ...
    def test_event_templates_are_valid_json(self):
        ...
        templates_to_test = [
            ...
            (self.stream_manager.AUDIO_EVENT_TEMPLATE, ("prompt", "content", "base64data")),
            (self.stream_manager.TEXT_CONTENT_START_EVENT, ("prompt", "content", "USER")),
            (self.stream_manager.TEXT_INPUT_EVENT, ("prompt", "content", "text")),
            (self.stream_manager.TOOL_CONTENT_START_EVENT, ("prompt", "content", "tool-id")),
    ...
    def test_prompt_name_consistency(self):
        ...
        assert prompt_event["event"]["promptStart"]["promptName"] == self.stream_manager.prompt_name